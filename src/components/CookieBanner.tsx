...
export default function CookieBanner() {
  ...
  useEffect(() => {
    ...
    if (!consent) {
      const timer = setTimeout(() => setIsVisible(true), 1500); // Appare con un leggero ritardo
  ...
  return (
    <div className="fixed bottom-6 left-6 right-6 md:left-auto md:right-8 md:w-[380px] bg-white border border-gray-100 shadow-[0_20px_50px_rgba(0,0,0,0.15)] rounded-2xl p-6 z-[9999] transition-all animate-in fade-in slide-in-from-bottom-5 duration-700">
      <div className="relative">
        ...
        <div className="flex items-start gap-4 mb-5">
          ...
          <div>
            <h4 className="text-[#1f2937] font-bold text-base leading-tight mb-1">Cookie Settings</h4>
            <p className="text-gray-500 text-[13px] leading-relaxed">
              We use cookies to ensure you get the best experience on TrackySheets. 
