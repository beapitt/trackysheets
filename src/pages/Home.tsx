    ...
    <div className="min-h-screen bg-[#f9fafb] font-sans text-left">
      ...
      <div className="max-w-7xl mx-auto flex min-h-screen">
        ...
        <main className="flex-1 p-8 bg-white border-l border-gray-200 shadow-inner">
          ...
          <section className="mb-12 border-b border-gray-100 pb-8">
            <h1 className="text-[32px] font-bold text-[#14532d] leading-tight mb-4 text-left">
              {settings?.hero_title || 'Professional Spreadsheet Templates'}
            </h1>
            <p className="text-[#1a8856] text-[11px] font-bold uppercase tracking-[0.2em] mb-6 text-left">
              Free Google Sheets Tools & Planners
            </p>
            
            <div className="text-gray-700 text-[15px] space-y-4 leading-relaxed max-w-4xl text-left">
          ...
          <div className="bg-[#14532d] text-white px-4 py-2 text-[11px] font-bold uppercase tracking-[0.15em] mb-8 text-left">
            All Templates
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {templates.map(item => (
              <Link key={item.id} to={`/template/${item.slug}`} className="group no-underline block">
                ...
                <h3 className="mt-4 font-bold text-gray-800 group-hover:text-[#1a8856] transition text-[16px] leading-snug text-left">
                  {item.title}
                </h3>
                <div className="mt-1 text-[10px] text-gray-400 uppercase font-bold tracking-wider text-left">
      ...
      <footer className="bg-white border-t border-gray-200 py-10">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-[12px] text-gray-400 font-medium text-left">
