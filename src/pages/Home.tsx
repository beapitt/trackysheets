...
import { Search, ArrowRight, MonitorPlay, Command } from 'lucide-react'

// Icona Pinterest coerente con Sidebar
const PinterestIcon = () => (
        ...
        <div className="flex flex-col lg:flex-row gap-[36px] items-start">
          ...
          <main className="flex-1 min-w-0 flex flex-col gap-10">
            ...
            <section className="pt-4">
              ...
              {/* SEO Sentence con bordo editoriale */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                {[
                  ...
                  <div key={s.n} className="bg-[#EAF3DE] rounded-xl p-4 flex flex-col">
                    ...
                    <span className="text-[11px] text-[#3B6D11] uppercase font-medium">{s.sub}</span>
                  </div>
                ))}
              </div>
            </section>

            {/* 2. NEWLY RELEASED - Header elegante senza barra */}
            <section>
              ...
              <div className="h-[0.5px] bg-gray-100 mb-6" />
            ...
            {/* 3. HOW IT WORKS - Numeri Outline */}
            <section className="border-t border-gray-100 pt-10 mb-10">
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 mb-6 text-center">How it works</p>
          ...
          {/* SIDEBAR IDENTICA AL PRODOTTO (0.26) */}
          <aside className="w-full lg:w-[260px] sticky top-24 pt-4 flex flex-col gap-10 lg:border-l lg:border-gray-50 lg:pl-8">
            ...
            <div className="flex flex-col gap-4">
               ...
               <div className="relative">
                  <input type="text" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} placeholder="Filter categories..." 
                         className="w-full bg-[#f5f4ed] border border-gray-100 rounded-lg py-2 pl-9 pr-4 text-xs font-bold text-gray-600 focus:ring-1 focus:ring-[#1F5C3E]" />
            ...
            <div className="flex flex-col gap-3">
               ...
               <a href="#" className="flex items-center justify-between border border-gray-200 rounded-full px-4 py-2 hover:bg-gray-50 no-underline transition-all">
