...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white overflow-x-hidden antialiased font-inter">
      <Navbar />
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 min-w-0">
            ...
            <section className="text-left mb-8">
              <p className="text-[10px] font-black tracking-[0.2em] uppercase text-[#1F5C3E] mb-2">Free Templates</p>
              <h1 className="text-[28px] md:text-[38px] font-bold text-[#1f2937] leading-tight mb-3">
